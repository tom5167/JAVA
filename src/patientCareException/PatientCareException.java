 ...
 */
package patientCareException;

@SuppressWarnings("serial")
public class PatientCareException extends Exception {
	public PatientCareException(String message) {
		super(message);
	}

	public PatientCareException(String message, Throwable cause) {
		super(message, cause);
	}
}